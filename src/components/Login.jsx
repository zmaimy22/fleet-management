      ...
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8">
        ...
        <div className="mt-8 p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-xs text-gray-600 space-y-1">
            <div>👔 Admin: <code className="bg-white px-2 py-1 rounded">admin</code> / <code className="bg-white px-2 py-1 rounded">admin123</code></div>
            <div>🚗 Conductor: <code className="bg-white px-2 py-1 rounded">conductor</code> / <code className="bg-white px-2 py-1 rounded">1234</code></div>
          </div>
        </div>
      </div>
    </div>
